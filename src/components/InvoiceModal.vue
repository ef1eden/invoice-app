...
export default {
    ...
    created() {
        ...
        if(!this.editInvoice) {
            this.paymentDueDateUnix = Date.now();
            this.invoiceDate = new Date(this.paymentDueDateUnix).toLocaleDateString('en-us', this.dateOptions);
        }      
        ...
        if(this.editInvoice) {
            ...
            this.invoiceDateUnix = currentInvoice.invoiceDataUnix;
